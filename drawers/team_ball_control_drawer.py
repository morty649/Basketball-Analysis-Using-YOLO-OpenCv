...
class TeamBallControlDrawer:
    ...
    def draw_frame(self,frame,frame_num,team_ball_control):
        ...
        team_1_percent = team_1_num_frames/team_ball_control_till_frame.shape[0]
        team_2_percent = team_2_num_frames/team_ball_control_till_frame.shape[0]

        cv2.putText(frame,f"Team 1 Control: {team_1_percent*100:.2f}%",(text_x,text_y1),cv2.FONT_HERSHEY_SIMPLEX,font_scale,(0,0,0),font_thickness)
        cv2.putText(frame,f"Team 2 Control: {team_2_percent*100:.2f}%",(text_x,text_y2),cv2.FONT_HERSHEY_SIMPLEX,font_scale,(0,0,0),font_thickness)
